...
INSERT INTO BANK_ACCOUNT VALUES ('Chirag',15000,10000,0);

SELECT * FROM BANK_ACCOUNT
BEGIN TRANSACTION 
INSERT INTO BANK_ACCOUNT VALUES('RIAYAZ',3500,1000,0)
SAVE TRANSACTION SP2
--INSERT INTO BANK_ACCOUNT VALUES('RAJNi',25000,1000,0);
DELETE FROM BANK_ACCOUNT WHERE CustomerName='RIAYAZ';
COMMIT TRANSACTION
SELECT *FROM BANK_ACCOUNT;
...
DELETE FROM BANK_ACCOUNT WHERE Customerid =3;
SAVE TRANSACTION SP2
...
INSERT INTO TRANSACTIONS VALUES(1,CURRENT_TIMESTAMP,2500,10000)
INSERT INTO TRANSACTIONS VALUES(3,CURRENT_TIMESTAMP,3000,10000)
